...
Read [`design-reference.md`](design-reference.md) for color palette options (18 curated palettes) and visual detail treatments (geometric patterns, borders, typography, charts, layouts, backgrounds).
